    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.grace2"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.grace2.tests.tests"

        To run tests in the Grace2TestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.Grace2.tests.tests.Grace2TestCase"

        To run only the test_if_tethys_platform_is_great function in the Grace2TestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.grace2.tests.tests.Grace2TestCase.test_if_tethys_platform_is_great"
...
class Grace2TestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(GRACE2)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(GRACE2)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/grace2/')  # The final '/' is essential for all pages/controllers
